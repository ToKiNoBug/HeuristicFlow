...
template<typename Scalar_t,
  int Dim,
  DoubleVectorOption DVO=DoubleVectorOption::Std,
  BoxShape BS=BoxShape::SQUARE_BOX,
  bool isFixedRange=false,
  Scalar_t MinCT=0,
  Scalar_t MaxCT=1>
...
using BoxNsS = typename std::enable_if<Dim!=Eigen::Dynamic,
  internal::SymbolBox<Scalar_t,Dim,DVO,BoxShape::SQUARE_BOX,isFixedRange,MinCT,MaxCT>>::type;
...
template<typename Scalar_t,
  ...
  Scalar_t MinCT=0,
  Scalar_t MaxCT=1>
using BoxXsS = internal::SymbolBox<Scalar_t,Eigen::Dynamic,
  DVO,BoxShape::SQUARE_BOX,isFixedRange,MinCT,MaxCT>;
